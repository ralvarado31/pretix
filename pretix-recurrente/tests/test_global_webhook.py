...
def test_global_webhook_payment_success(client, event, order, payment, monkeypatch):
    """
    Prueba que el webhook global procese correctamente un pago exitoso
    """
    # Simular un webhook global de pago exitoso
    webhook_data = {
    ...
    # Llamar al endpoint del webhook global
...
@pytest.mark.django_db
def test_global_webhook_payment_failed(client, event, order, payment, monkeypatch):
    """
    Prueba que el webhook global procese correctamente un pago fallido
    """
    # Simular un webhook global de pago fallido
    webhook_data = {
